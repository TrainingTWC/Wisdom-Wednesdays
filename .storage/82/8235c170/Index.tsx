    ...
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-yellow-50">
      ...
      <main className="container mx-auto px-4 py-6 md:py-12">
        ...
        <Tabs value={currentTab} onValueChange={handleTabChange} className="w-full">
          <TabsList className="grid w-full grid-cols-3 md:grid-cols-6 gap-1 md:gap-0 mb-6 md:mb-8 bg-white shadow-md h-auto rounded-xl p-1">
            <TabsTrigger 
              value="intro" 
              className="data-[state=active]:bg-amber-600 data-[state=active]:text-white py-2 md:py-3 text-xs md:text-sm rounded-lg transition-all duration-300 min-h-[44px]"
            >
              Intro
            </TabsTrigger>
            <TabsTrigger 
              value="bad" 
              className="data-[state=active]:bg-red-600 data-[state=active]:text-white py-2 md:py-3 text-xs md:text-sm rounded-lg transition-all duration-300 min-h-[44px]"
            >
              <span className="hidden md:inline">Bad Service</span>
              <span className="md:hidden">Bad</span>
            </TabsTrigger>
            <TabsTrigger 
              value="average" 
              className="data-[state=active]:bg-amber-600 data-[state=active]:text-white py-2 md:py-3 text-xs md:text-sm rounded-lg transition-all duration-300 min-h-[44px]"
            ...
            <TabsTrigger 
              value="excellent" 
              className="data-[state=active]:bg-green-600 data-[state=active]:text-white py-2 md:py-3 text-xs md:text-sm rounded-lg transition-all duration-300 min-h-[44px]"
            >
              Excellent
            </TabsTrigger>
            <TabsTrigger 
              value="reflection" 
              className="data-[state=active]:bg-purple-600 data-[state=active]:text-white py-2 md:py-3 text-xs md:text-sm rounded-lg transition-all duration-300 min-h-[44px]"
            >
              Reflection
            </TabsTrigger>
            <TabsTrigger 
              value="assessment" 
              className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-pink-600 data-[state=active]:to-purple-600 data-[state=active]:text-white py-2 md:py-3 text-xs md:text-sm rounded-lg transition-all duration-300 min-h-[44px]"
            >

...
export default function Index() {
  ...
  const sections = ['intro', 'bad', 'average', 'excellent', 'reflection'];
    ...
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-yellow-50">
      ...
      <main className="container mx-auto px-4 py-12">
        ...
        <Tabs value={currentTab} onValueChange={handleTabChange} className="w-full">
          <TabsList className="grid w-full grid-cols-5 mb-8 bg-white shadow-md h-auto">
            <TabsTrigger 
              value="intro" 
          ...
          <TabsContent value="reflection" className="animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="flex justify-center mt-8">
              <Card className="bg-gradient-to-r from-green-50 to-emerald-50 border-2 border-green-500 shadow-xl max-w-md">
                <CardHeader>
                ...
                <CardContent className="text-center">
                  <p className="text-gray-700 mb-4">
                    You've completed Section 1: What Great Service Looks Like
                  </p>
                  <p className="text-sm text-gray-600">
                    Remember: Connection over perfection. Your energy shapes the experience.
                  </p>
                </CardContent>
              </Card>
            </div>

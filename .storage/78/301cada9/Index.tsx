    ...
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-yellow-50">
      ...
      <main className="container mx-auto px-4 py-12">
        ...
        <Tabs value={currentTab} onValueChange={handleTabChange} className="w-full">
          <TabsList className="grid w-full grid-cols-6 mb-8 bg-white shadow-md h-auto rounded-xl">
            <TabsTrigger 
              value="intro" 
              className="data-[state=active]:bg-amber-600 data-[state=active]:text-white py-3 text-sm rounded-lg transition-all duration-300"
            >
              Intro
            </TabsTrigger>
            <TabsTrigger 
              value="bad" 
              className="data-[state=active]:bg-slate-600 data-[state=active]:text-white py-3 text-sm rounded-lg transition-all duration-300"
            >
              Bad Service
            </TabsTrigger>
            <TabsTrigger 
              value="average" 
              className="data-[state=active]:bg-gray-600 data-[state=active]:text-white py-3 text-sm rounded-lg transition-all duration-300"
            >
              Average
            </TabsTrigger>
            <TabsTrigger 
            ...
            <TabsTrigger 
              value="reflection" 
              className="data-[state=active]:bg-purple-600 data-[state=active]:text-white py-3 text-sm rounded-lg transition-all duration-300"
            >
              Reflection
            </TabsTrigger>
            <TabsTrigger 
              value="assessment" 
              className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-pink-600 data-[state=active]:to-purple-600 data-[state=active]:text-white py-3 text-sm rounded-lg transition-all duration-300"
            >
              Assessment
            </TabsTrigger>
          </TabsList>
          ...
          <TabsContent value="intro" className="animate-in fade-in slide-in-from-bottom-4 duration-500">
            <Card className="border border-amber-200 bg-gradient-to-br from-white to-amber-50 shadow-lg rounded-xl">
              ...
              <CardContent className="space-y-6">
                ...
                <div className="bg-amber-100 border-l-4 border-amber-600 p-6 rounded-xl">
                ...
                <div className="text-center pt-4">
                  ...
                  <Button 
                    onClick={handleNext}
                    className="bg-amber-600 hover:bg-amber-700 text-white px-8 py-6 text-lg rounded-xl shadow-md transition-all duration-300"
                  >
          ...
          <TabsContent value="bad" className="animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="flex justify-end mt-6">
              <Button 
                onClick={handleNext}
                className="bg-amber-600 hover:bg-amber-700 text-white px-6 py-3 rounded-xl shadow-md transition-all duration-300"
              >
          ...
          <TabsContent value="reflection" className="animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="flex justify-end mt-8">
              <Button 
                onClick={handleNext}
                className="bg-gradient-to-r from-pink-600 to-purple-600 hover:from-pink-700 hover:to-purple-700 text-white px-8 py-4 text-lg shadow-lg rounded-xl transition-all duration-300"
              >

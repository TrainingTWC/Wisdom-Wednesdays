...
export default function ServiceSection({
  ...
  const colorClasses = {
    cold: 'from-slate-100 to-blue-100 border-slate-200',
    neutral: 'from-gray-100 to-stone-100 border-gray-200',
    ...
    <Card className={`border bg-gradient-to-br ${colorClasses[colorScheme]} transition-all duration-300 hover:shadow-xl rounded-xl`}>
      <CardHeader>
        <div className="flex items-start justify-between">
          ...
          <Badge className={`${badgeColors[colorScheme]} text-white shadow-sm`}>
      ...
      <CardContent className="space-y-6">
        ...
        <div className={`relative w-full h-64 rounded-xl overflow-hidden border ${
          colorScheme === 'cold' ? 'bg-gradient-to-br from-slate-200 to-blue-200 border-slate-300' :
          colorScheme === 'neutral' ? 'bg-gradient-to-br from-gray-200 to-stone-200 border-gray-300' :
          colorScheme === 'warm' ? 'bg-gradient-to-br from-amber-100 to-orange-100 border-amber-300' :
          'bg-gradient-to-br from-purple-100 to-pink-100 border-purple-300'
        } flex items-center justify-center transition-transform duration-300 hover:scale-[1.02] shadow-sm`}>
        ...
        {caption && (
          <p className="text-center text-sm font-medium text-gray-700 italic bg-white/50 p-3 rounded-xl">
            "{caption}"
          </p>
        )}
        ...
        <div className="mt-4">
          ...
          {showTakeaway && (
            <div className="mt-3 p-4 bg-amber-50 border border-amber-500 rounded-xl animate-in slide-in-from-top-2 duration-300 shadow-sm">
